			...
			<div data-custom-class="body">
						...
						<strong>
							<span style={{ fontSize: 15 }}>
								<span data-custom-class="subtitle">
									Last updated <bdt className="question">June 11, 2022</bdt>
								</span>
							</span>
						</strong>
					</span>
					...
					<span style={{ color: 'rgb(127, 127, 127)' }}>
						<span style={{ color: 'rgb(89, 89, 89)', fontSize: 15 }}>
							<span data-custom-class="body_text">
								...
								<bdt className="question">Omar maroki</bdt>
							...
							<span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
								<span data-custom-class="body_text">
									...
									<bdt className="question">
										<a
											href="http://www.ctradetracker.co.uk"
											target="_blank"
											data-custom-class="link"
											rel="noreferrer"
										>
											http://www.ctradetracker.co.uk
										</a>
									</bdt>
									<span style={{ fontSize: 15 }}>
										<span style={{ color: 'rgb(89, 89, 89)' }}>
				...
				<div>
						...
						<span style={{ fontSize: 15 }}>
							<span style={{ color: 'rgb(127, 127, 127)' }}>
								<span data-custom-class="body_text">
									...
									<bdt className="question">marokiman@googlemail.com</bdt>.
								</span>
							</span>
						</span>
					</div>
					...
					<div style={{ lineHeight: '1.5' }}>
						...
						<a
							data-custom-class="link"
							href="https://app.termly.io/notify/a49ccb80-e234-444a-a1d7-17c055f6d438"
							...
							<span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
								<span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
									<span data-custom-class="body_text">
										<span style={{ fontSize: 15 }}>
											<span data-custom-class="body_text">
												<bdt className="question">google auth</bdt>
											</span>
										</span>
									</span>
								</span>
